    ...
    <>
      ...
      <FooterLower>
        <p>
          ...
          Asfotos contidas nesta página são meramente ilustrativas do produto
          epodem variar de acordo com o fornecedor/lote do fabricante. Este{" "}
          <br /> site trabalha 100% em criptografia SSL. Clique aqui e veja as
          políticas de nossa empresa.
        </p>
      </FooterLower>
    </>
  );
